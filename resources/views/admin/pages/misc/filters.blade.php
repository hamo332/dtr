    ...
    <div class="d-flex flex-wrap align-items-center my-1">
        ...
        <div class="d-flex align-items-center position-relative my-1" data-kt-docs-table-toolbar="base">
            ...
            <form id="table-search">
                <input type="text" class="form-control form-control-sm border-body bg-body w-150px ps-10 search-records list-actions-search" id="kt_filter_search" data-url="{{route('admin.pages.render')}}" data-type="form" data-ajax-type="post" data-form-id="table-search" name="key" placeholder="{{__('admin.fltr_search')}}">
            </form>
        </div>
        <!--end::Search-->
                ...
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="filter_menu" style="">
                    ...
                    <div class="px-7 py-5">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="reset" class="btn btn-sm btn-light btn-active-light-primary me-2 js-ajax-ux-request" data-url="{{route('admin.pages.render')}}" data-ajax-type="post" data-kt-menu-dismiss="true">{{__('admin.fltr_reset')}}</button>
                            <button type="submit" class="btn btn-sm btn-primary js-ajax-ux-request" data-kt-menu-dismiss="true" data-url="{{route('admin.pages.render')}}" data-type="form" data-ajax-type="post" data-form-id="filter_menu">{{__('admin.fltr_apply')}}</button>
                        </div>
                        <!--end::Actions-->
                    </div>
                    <!--end::Form-->
