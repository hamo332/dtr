...
@section('content')
    ...
    @section('toolbar-actions')
        @include('admin.profile.misc.list_actions')
    @endsection
            ...
            <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="{{asset($user->image->file_name ?? 'assets/admin/media/avatars/blank.png')}}" alt="{{$user->name}}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="{{asset('assets/admin/media/svg/brand-logos/google-icon.svg')}}" class="w-30px me-6" alt="" />
                                        <div class="d-flex flex-column">
                                            <a href="#" class="fs-5 text-dark text-hover-primary fw-bold">{{__('admin.google')}}</a>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input" name="google" type="checkbox" value="1" id="kt_modal_connected_accounts_google" disabled />
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="{{asset('assets/admin/media/svg/brand-logos/facebook-3.svg')}}" class="w-30px me-6" alt="" />
                                        <div class="d-flex flex-column">
                                            <a href="#" class="fs-5 text-dark text-hover-primary fw-bold">{{__('admin.facebook')}}</a>
                                            <div class="fs-6 fw-semibold text-muted">{{__('admin.sh_inactive')}}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input" name="facebook" type="checkbox" value="1" id="kt_modal_connected_accounts_facebook" disabled />
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                            <span class="form-check-label fw-semibold text-muted" for="kt_modal_connected_accounts_facebook"></span>
                                            <!--end::Label-->
                                        </label>
                                        <!--end::Switch-->
                                    </div>
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_user_account">{{__('admin.us_account')}}</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_security">{{__('admin.us_security')}}</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_user_activity">{{__('admin.us_activity')}}</a>
                        </li>
                        <!--end:::Tab item-->
                    </ul>
                    <!--end:::Tabs-->
