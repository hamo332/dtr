...
@section('title', __('admin.sm_chat_title'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title fs-3 fw-bold">{{__('admin.sm_chat_title')}}</div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->
                <!--begin::Form-->
                <form id="kt_chat_settings_form" class="form form-validation">
                    @csrf
                    @php 
                        $data = json_decode(get_setting('facebook_chat'));
                    @endphp
                    <!--begin::Card body-->
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" id="status" name="facebook_chat[status]" value="@if($data) {{$data->status ?? 'off'}} @endif" @if($data) {{$data->status == 'on' ? 'checked' : ''}} @endif/>
                        ...
                        <div class="row mb-8 field @if($data) {{$data->status == 'on' ? '' : 'd-none'}} @else d-none @endif">
                            <!--begin::Col-->
                            <div class="col-xl-3">
                                <div class="fs-6 fw-semibold mt-2 mb-3">{{__('admin.sm_facebook_chat_id')}}</div>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-xl-9 fv-row">
                                <textarea name="facebook_chat[id]" placeholder="{{__('admin.sm_facebook_chat_id')}}" class="form-control form-control-solid" data-kt-autosize="true">{{$data->id ?? ''}}</textarea>
                            </div>
                            <!--begin::Col-->
                        </div>
                        <!--end::Row-->
