<div class="d-flex align-items-center gap-2 gap-lg-3">
    <!--begin::add button-->
    <button class="btn btn-sm fw-bold btn-primary hover-rotate-end edit-add-modal-button js-ajax-ux-request reset-target-modal-form" data-bs-toggle="modal" data-bs-target="#commonModal" data-url="{{route('admin.roles.create')}}" data-loading-target="commonModalBody" data-modal-title="{{__('admin.roles_create')}}" data-action-url="{{route('admin.roles.store')}}" data-action-method="POST"  data-action-ajax-loading-target="commonModalBody">
