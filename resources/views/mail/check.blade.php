											...
											<div style="text-align:center; margin:0 15px 34px 15px">
												...
												<div style="margin-bottom: 10px">
													<a href="{{env('APP_URL')}}" rel="noopener" target="_blank">
														<img alt="Logo" src="{{asset(getFileById(get_setting('logo'))->file_name)}}" style="height: 35px" />
													</a>
												</div>
												<!--end:Logo-->
												<!--begin:Media-->
												<div style="margin-bottom: 15px">
													<img alt="Logo" src="{{asset('assets/admin/media/email/icon-positive-vote-1.svg')}}" />
												</div>
												<!--end:Media-->
												<!--begin:Text-->
												<div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
													<p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">Hey {{Auth::user()->name}}, Thank you so much!</p>
													<p style="margin-bottom:2px; color:#7E8299">This is a test mail from {{get_setting('site_name')}}</p>
													<p style="margin-bottom:2px; color:#7E8299">if you received this mail that means everything is okay.</p>
													<p style="margin-bottom:2px; color:#7E8299">Dont't worry about mail config</p>
												</div>
												<!--end:Text-->
												<!--begin:Action-->
												<a href='{{getBaseURL()}}' target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">Go back to dashboard</a>
												<!--begin:Action-->
											</div>
											<!--end:Email content-->
										</td>
